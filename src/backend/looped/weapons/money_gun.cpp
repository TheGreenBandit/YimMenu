...
namespace big
{
	void looped::weapons_money_gun()
	{
		...
		if (bMoneyGun)
		{
			...
			{
				if (PAD::IS_CONTROL_JUST_RELEASED(0, (int)ControllerInputs::INPUT_ATTACK) && WEAPON::GET_WEAPON_DAMAGE_TYPE(g_local_player->m_weapon_manager->m_weapon_info->m_human_name_hash) != 1 || 0 || 2)
				{
